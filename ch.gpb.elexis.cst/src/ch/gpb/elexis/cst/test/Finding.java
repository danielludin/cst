...
public class Finding {
	...
	public Finding(Date dateOfFinding, String sParam, double value,
	...
	public static List<Finding> getFindings1() {
	...
	public static List<Finding> getFindings2() {
	...
	public static List<Finding> getFindings3() {
	...
	public static List<Finding> getFindings4() {
	...
	public static List<Finding> getFindings5() {
	...
	public static List<Finding> getFindings(String parameter) {
