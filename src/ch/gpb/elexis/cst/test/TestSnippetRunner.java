...
public class TestSnippetRunner {

	public static void doIt() {
		/*
				String sRangeStart = " 50";
				...
				try {
					...
					System.err.println("NumberFormatExceptio" + e.toString());
				} catch (ArrayIndexOutOfBoundsException e) {
					System.err
							.println("ArrayIndexOutOfBoundsException " + e.toString());
				}
